...
<div class="person-grid">
  ...
  <div class="person-card">
    <div class="person-avatar placeholder">TN</div>
    <h3>Tomotoshi Nishino</h3>
    <p>Kobe University</p>
  </div>
...
<div class="person-grid">
  ...
  <div class="person-card">
    ...
    <h3>Ying-Jer Kao</h3>
    <p>National Taiwan University (NTU)</p>
  </div>
  ...
  <div class="person-card">
    ...
    <h3>Tao Xiang</h3>
    <p>Beijing Academy of Quantum Information Sciences (BAQIS)</p>
  </div>
